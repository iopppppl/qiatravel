...
- (instancetype)initWithFrame:(CGRect)frame
{
    if (self = [super initWithFrame:frame]) {
        [self createHeadView];
        UITableView * tableView = [[UITableView alloc]initWithFrame:CGRectMake(0, CGRectGetMaxY(self.imgView.frame), kScreenWidth, kScreenHeight) style:UITableViewStyleGrouped];
...
- (void)createHeadView
{
    ...
    UILabel * nameLabel = [[UILabel alloc]initWithFrame:CGRectMake(nameLabelX, 30, kScreenWidth, 50)];
    ...
    //下划线
    CGFloat botNameX = (kScreenWidth - 300)*0.5;
    ...
    //标题
    CGFloat titleLabelX = (kScreenWidth - 200)*0.5;
